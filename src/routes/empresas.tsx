                ...
                <tr key={e.id} style={{ borderTop: "1px solid #e2e5f0" }}>
                  ...
                  <Td>
                    <span
                      ...
                      style={{
                        background: e.ativo ? "#22c55e22" : "#94a3b822",
                        color: e.ativo ? "#16a34a" : "#475569",
                      }}
                    >
                      <span
                        className="w-1.5 h-1.5 rounded-full"
                        style={{ background: e.ativo ? "#22c55e" : "#94a3b8" }}
                      />
                  ...
                  <Td>
                    {confirmId === e.id ? (
                      ...
                      >
                        ...
                        <span className="text-[11px] font-medium mr-1" style={{ color: "#ef4444" }}>
                          Confirmar exclusão?
                        </span>
                        <button
                          onClick={async () => {
                          ...
                          <>
                            ...
                            <button
                              onClick={async () => {
                                ...
                                toast.success(
                                  e.ativo
                                    ? `${e.nomeFantasia} desativada`
                                    : `${e.nomeFantasia} ativada`,
                                );
                              }}
      ...
      {isSupervisor && (
        <EmpresaForm
          ...
          onSave={async (emp) => {
            ...
            toast.success(
              isNew
                ? `Empresa "${emp.nomeFantasia}" criada`
                : `Empresa "${emp.nomeFantasia}" atualizada`,
            );
          }}
        />
      )}
