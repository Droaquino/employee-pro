                  ...
                  <Td>
                    {confirmId === e.id ? (
                      <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg" style={{ background: "#fef2f2", border: "1px solid #fecaca" }}>
                        ...
                        <button
                          onClick={() => { removeEmpresa(e.id); setConfirmId(null); toast.success("Empresa excluída"); }}
                          className="px-2.5 py-1 rounded-md text-[11px] font-medium text-white transition-opacity hover:opacity-90"
                      ...
                      <div className="inline-flex items-center gap-1 p-1 rounded-lg" style={{ background: "#f8fafc", border: "1px solid #e2e5f0" }}>
                        ...
                        <Link
                          to="/empresas/$id"
                          params={{ id: e.id }}
                          className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-[11px] font-medium text-white transition-opacity hover:opacity-90"
                          style={{ background: "#071040" }}
                        >
                        ...
                        {/* Ativar / Desativar */}
                        <button
                          onClick={() => { toggleAtivo(e.id); toast.success(e.ativo ? `${e.nomeFantasia} desativada` : `${e.nomeFantasia} ativada`); }}
                          className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-[11px] font-medium transition-colors"
                          style={{
                            color: e.ativo ? "#d97706" : "#16a34a",
                            background: e.ativo ? "#fffbeb" : "#f0fdf4",
                          }}
                        >
                          {e.ativo ? (
